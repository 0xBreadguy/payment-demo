...
MegaETH testnet — chain id `6343` (live RPC), RPC `https://carrot.megaeth.com/rpc`, explorer via [testnet-mega.etherscan.io](https://testnet-mega.etherscan.io/). Faucet via [testnet.megaeth.com](https://testnet.megaeth.com).
